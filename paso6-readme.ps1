# ============================================================
#  PASO 6 - README con las 7 secciones obligatorias
...
Write-Host ""
Write-Host "PASO 6 - README con las 7 secciones obligatorias" -ForegroundColor Cyan
Write-Host ""
...
| Código estudiantil | `__________` |
| Correo institucional | `__________@mail.escuelaing.edu.co` |
...
|---|---|---|
| [#1](https://github.com/JulianMorales2003/DOSW-Taller2-Bowling-Morales-Julian/pull/1) | Módulos A y C — `BowlingGame.roll()` e `isComplete()` | `____-__-__` |
| [#2](https://github.com/JulianMorales2003/DOSW-Taller2-Bowling-Morales-Julian/pull/2) | Módulo B — `BowlingScorer` | `____-__-__` |
| [#3](https://github.com/JulianMorales2003/DOSW-Taller2-Bowling-Morales-Julian/pull/3) | Pruebas adicionales, JaCoCo y correcciones de SonarQube | `____-__-__` |
| [#4](https://github.com/JulianMorales2003/DOSW-Taller2-Bowling-Morales-Julian/pull/4) | README y evidencias | `____-__-__` |
...
Write-Host ""
Write-Host "Completa a mano: codigo estudiantil, correo, porcentajes de JaCoCo," -ForegroundColor White
Write-Host "tabla de SonarQube, fechas de los PR y la pregunta 04." -ForegroundColor White
Write-Host "Luego:" -ForegroundColor White
Write-Host "  git add README.md" -ForegroundColor White
Write-Host "  git commit -m `"docs: README con evidencias y reflexion`"" -ForegroundColor White
Write-Host ""
